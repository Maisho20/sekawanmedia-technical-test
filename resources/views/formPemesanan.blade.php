            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('storePemesanan') }}" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="mb-4 form-group">
                        ...
                        <input type="text" name="driverName" class="form-control form-control-alternative"
                            id="driverName" placeholder="Masukkan nama driver" required>
                    </div>
                    <div class="mb-4 form-group">
                        <label class="text-gray-900 font-weight-bold" for="orderDate">Tanggal Pemesanan</label>
                        <input type="date" name="orderDate" class="form-control form-control-alternative" id="orderDate"
                            required>
                    </div>
                    <div class="mb-4 form-group">
                        <label class="text-gray-900 font-weight-bold" for="endDate">Tanggal Pengembalian</label>
                        <input type="date" name="endDate" class="form-control form-control-alternative" id="endDate"
                            required>
                    </div>
                    <div class="mb-4 form-group">
                        <label class="text-gray-900 font-weight-bold" for="vehicleId">Kendaraan</label>
                        <select class="form-select form-control" aria-label="Default select example" name="vehicleId"
                            required>
